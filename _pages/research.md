...
![]({{ site.url }}{{ site.baseurl }}/images/research/root.jpg){: style="width: 100%; display: block; margin: 20px auto"}  
<!-- ![]({{ site.url }}{{ site.baseurl }}/images/research/respic_root.webp){: style="width: 70%; display: block; margin: 20px auto"}   -->
<!-- **Key Points:**   -->
...
<!-- ![]({{ site.url }}{{ site.baseurl }}/images/research/macropore_salt.jpg){: style="width: 100%; display: block; margin: 20px auto"}   -->
![]({{ site.url }}{{ site.baseurl }}/images/research/fig_evap_salt.jpg){: style="width: 50%; display: block; margin: 20px auto"}  
...
<!-- ![]({{ site.url }}{{ site.baseurl }}/images/respic/microbes.jpg){: style="width: 70%; display: block; margin: 20px auto"}   -->
